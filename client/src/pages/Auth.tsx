      ...
      <section className="flex min-h-screen items-center justify-center p-5 sm:p-8">
        <div className="w-full max-w-md">
          ...
          <div className="rounded-3xl border border-[#323846] bg-[#1D232F] p-6 shadow-2xl shadow-black/20 sm:p-8">
            ...
            {mode === "signin" && <div className="mt-6 border-t border-[#323846] pt-5 text-center"><p className="text-xs leading-5 text-[#8B93A3]">Prefer a faster sign-in?</p><button type="button" onClick={() => startHostedLogin("signIn")} className="mt-3 inline-flex h-11 w-full items-center justify-center gap-3 rounded-xl border border-[#323846] bg-[#161B26] text-sm font-bold text-[#F5F7FA] transition hover:border-[#0B72E7] hover:bg-[#0360B9]/15" aria-label="Continue with Google"><span className="grid h-6 w-6 place-items-center rounded-full bg-white text-sm font-extrabold text-[#4285F4]">G</span>Continue with Google</button><p className="mt-2 text-[11px] text-[#8B93A3]">Securely continue through Google’s hosted account flow.</p></div>}
          </div>
        </div>
      </section>
    </main>
