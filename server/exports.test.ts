...
import { buildChatTranscript, buildEnrichedCsv, buildExecutiveReportSections, safeExportName } from "../client/src/lib/exports";
...
describe("SentiX export payloads", () => {
  ...
  it("prepares safe names and readable transcripts for assistant export", () => {
