...
const review = { id: "rv-101", text: "Refund processing took too long.", source: "reviews.xlsx", rating: 1, category: "Refunds", label: "Negative" as const, compound: -0.72, confidence: 94, vaderCompound: -0.7, transformerLabel: "Negative" as const, transformerConfidence: 93, transformerUsed: true, actionTag: "Investigate refund workflow", timestamp: 1_726_000_000_000 };
...
describe("SentiX workspace persistence transformations", () => {
  it("serializes analyzed reviews to the saved workspace row format", () => {
    ...
    expect(row).toMatchObject({ workspaceId: 42, clientReviewId: "rv-101", compound: "-0.72", vaderCompound: "-0.7", transformerLabel: "Negative" });
  ...
  it("hydrates saved reviews and prompt history for reopening a workspace", () => {
    ...
    expect(state.reviews[0]).toMatchObject({ id: "rv-101", compound: -0.72, category: "Refunds", transformerLabel: "Negative" });
